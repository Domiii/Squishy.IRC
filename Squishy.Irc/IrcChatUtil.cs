...
namespace Squishy.Irc
{
	public static class IrcChatUtil
	{
		...
		/// Ctrl + B in mIRC (\u0002)
		/// </summary>
		public const char BoldControlCode = '\u0002';

		/// <summary>
		/// Ctrl + K in mIRC (\u0003)
		/// </summary>
		public const char ColorControlCode = '\u0003';

		/// <summary>
		/// Ctrl + U in mIRC (\u001F)
		/// </summary>
		public const char UnderlineControlCode = '\u001F';

		/// <summary>
		/// Ctrl + O in mIRC (\u000F)
		/// </summary>
		public const char ControlEndCode = '\u000F';
		...
		{
			return ColorControlCode.ToString() + (int)color;
		}
